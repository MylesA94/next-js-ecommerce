...
// simple wait function to force a wait
...
export default async function AdminDashboard() {
    ...
    // customize this page to look like a useful dashboard.
    return (
...
function DashboardCard({title,subTitle, body}: DashboardCardProps) : JSX.Element {
    return (
        <Card>
            <CardHeader>
